...
function setBackground() {
    ...
    reader.addEventListener("load", function () {
        ...
        backgroundImage.onload = function () {
            ...
            // Draw and stretch image to fill canvas
        };
    }, false);
...
function modelSelect() {
    ...
    switch (selectedModel) {
        ...
        case "model1":
            // If model1 was selected, draw pattern using 3 new canvas elements as layers on top of background canvas

            document.getElementById("background").style.visibility = "visible";
            // Make  background canvas visible
            ...
            // Same as above ... create second square canvas..etc
        ...
        case "model2":
            // If model2 was selected, draw pattern using 2 new canvas elements as layers on top of background canvas
        ...
        case "model3":
            // If model3 was selected, draw pattern using 2 new canvas elements as layers on top of background canvas
        ...
        // Hide canvas until model is selected
    }
}
